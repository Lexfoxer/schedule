...
(function() {
  'use strict';
  var TelegramBot, lessons, lessons_to_string, my_date, tb, token;
  ...
  token = '230315571:AAEF0XGGbGb91eU3hTSwuVrGqKKBrZKrdqE';
  ...
  lessons_to_string = function(chatId, array_data, even_week, code_week, callback) {
    ...
    for (i = 0, len = array_data.length; i < len; i++) {
      ...
      if (key.even_week === even_week) {
        out += "<b>" + my_date.dic_timeLessons[key.number_lesson] + "</b>\n" + key.title + ", " + key.class_room + "\n<b>--------------------</b>\n";
      }
    }
    if (out !== "") {
