...
(function() {
  'use strict';
  var TelegramBot, create_send_message, generation_event_new_messages, how_time_out, how_time_to_univer, lessons, lessons_to_string, my_date, out_string, tb, token;
  ...
  how_time_to_univer = function(string_time) {
    var arr_time, gen_time;
    arr_time = string_time.split(':');
    gen_time = arr_time[0] * 360000 + arr_time[1] * 60000;
    return console.log(gen_time);
  };

  how_time_to_univer("1:30");

  how_time_out = function(in_time) {
