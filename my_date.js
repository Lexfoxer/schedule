...
(function() {
  'use strict';
  var TZO, dictionary_DayWeek, dictionary_Months, dictionary_TimeLessons, dictionary_ru_to_eng, getNumberLessonsWeek, startDay, startWeek, toDate;
  ...
  toDate = function(date, callback) {
    var arr_date, code_week_fn, day_week, new_date;
    arr_date = date.split(' ');
